...
$mySQL_ok = version_compare($myVersion, '5.1.5', '>=');
...
if (!$version_check || !$url_status || !$curl_status || !$apache_installed || !$bc_filter_installed || !$innoDB_available || !$mySQL_ok) {
  $PRECHECK['CUSTOM_CHECKS'] = array(
      'Server configuration' => array(
          'REQUIRED' => "Needed configuration:<br /><br />".
                  "PHP version >= 5.3.3 (actual: ".PHP_VERSION.")<br />".
                  "Server software: APACHE<br />".
                  "cURL extension installed<br />".
                  "php.ini setting: allow_url_fopen = 1<br />$blackCat".
                  "MySQL version >= 5.1.5 (actual: $myVersion)<br />".
